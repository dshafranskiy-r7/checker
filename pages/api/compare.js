import { resolveSteamId, getSteamGames } from '../../lib/steam.js';
import { getPortmasterGames, getImageUrl } from '../../lib/portmaster.js';
import { compareGames } from '../../lib/gameComparison.js';
...
function generateReport(steamGames, portmasterGames, comparison) {
  return `
    ...
    <body>
        ...
        <div class="matches">
            <h2>Potential Portmaster Ports for Your Steam Games:</h2>
            ${comparison.matches.map(match => `
                <div class="match" style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <p style="margin: 0 0 15px 0; color: var(--playtime-color); font-size: 0.9em;">
                            <strong>Steam Playtime:</strong> ${match.playtime} hours
                        </p>
                        <div style="margin-top: 10px;">
                            <a href="https://store.steampowered.com/app/${match.steamAppId}" 
                               target="_blank" 
                               style="background: #171a21; color: white; padding: 5px 10px; text-decoration: none; border-radius: 3px; font-size: 0.9em; margin-right: 10px;">
                                View on Steam
                            </a>
